...
function parseVideos(response){
  ...
  for (var i = 0; i < 5; i++) {
    ...
    html += '<h4 class="border-gray pb-2 mb-0" style="margin-top:20px;">' + tempPath.items[i].snippet.title + '</h4><br>';
    html += '<iframe width="840" height="473" src="https://www.youtube.com/embed/'+ tempPath.items[i].id.videoId +' " frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>';
    console.log(html);
  };
